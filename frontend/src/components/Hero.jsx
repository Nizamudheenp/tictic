      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 w-full z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center text-left">
            <span className="inline-flex self-start items-center gap-1.5 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-amber-600 bg-amber-50 rounded-full mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-amber-500 animate-ping" />
              Hot Trending Now
            </span>
            
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-gray-900 leading-none tracking-tight">
              Curated Finds <br />
              For Your Modern <br />
          ...
          <div className="lg:col-span-5 flex justify-center items-center">
            <div className="relative p-4 bg-white/70 backdrop-blur-md rounded-[2.5rem] border border-white/50 shadow-2xl hover:shadow-3xl transition-shadow duration-500 max-w-md w-full">
              <div className="overflow-hidden rounded-[1.8rem] bg-gray-100 aspect-[4/5] shadow-inner">
                <img
              ...
              <div className="absolute -bottom-6 -left-6 bg-white/95 backdrop-blur-md p-4 rounded-2xl border border-gray-100 shadow-xl flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-primary-50 flex items-center justify-center text-primary-500 font-black">
                  ★
                </div>
                <div>
                  <h4 className="text-sm font-bold text-gray-900">4.9/5 Rating</h4>
                  <p className="text-[10px] text-gray-400 font-semibold">Over 10k Customers</p>
                </div>
              </div>
            </div>
          </div>
