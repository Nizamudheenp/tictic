    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          <div className="mt-20 bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-8 max-w-2xl">
      ...
      >
        <div className="absolute inset-0 bg-black/40 rounded-xl"></div>
        <div className="relative z-10">
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-8 max-w-2xl">
